...
class TestOptions(BaseOptions):
	def initialize(self):
		...
		self.parser.add_argument('--offscreen_audio_path', type=str, required=True)
		...
		self.parser.add_argument('--noise_weight', type=float, default=1, help="weight for noise audio")
